...
// Constants indicating how the data is stored
	...
	public static ImageProducer getBMPImage(InputStream stream) throws IOException
	{
...
// stored upside-down - the bottom line is stored first.
	...
	protected static void readRGB24(int width, int height, int[] pixels, DataInputStream in) throws IOException
	{
...
// The bits represent indices into the color table.
	...
	protected static void readRGB(int width, int height, int[] colorTable, int bitCount, int[] pixels, DataInputStream in) throws IOException
	{
...
// readRLE reads run-length encoded data in either RLE4 or RLE8 format.
    ...
    protected static void readRLE(int width, int height, int[] colorTable, int bitCount, int[] pixels, DataInputStream in, int imageSize, int pixelSize) throws IOException
	{
		int x = 0;
		int y = height - 1;

...
public class TemplateLayouter implements GridLayouter
{
    ...
    */
	 ...
	 * ----------------------------------------------------------------------- getCellAt
	 */
	public void getCellAt(Point pk, CellLocation was)
	{		// TODO hier muessen wir ran, wenn wir die RepeaterIndicators aktiv machen.
		was.model = null;
		was.col = -1;
		was.row = -1;
    ...
    */
	...
	public void layoutOuter(GridLayouter inner, Graphics2D g)
	{		// Trace.log(6, Trace.layout, "layoutOuter");
	...
	private int paintCell(int r, int c, Graphics2D g)
	{
		...
		try
		{
			...
			if (anyBorderSet)
			{				// hier wird auch der Platz für die Border berücksichtigt

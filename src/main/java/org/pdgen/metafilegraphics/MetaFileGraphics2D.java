...
public class MetaFileGraphics2D extends Graphics2D implements DrawCommands
{
		...
		while (!pi.isDone())
		{
			switch (pi.currentSegment(coords))
			{
				case PathIterator.SEG_MOVETO:
					out.writeCmd(DrawCommands.SEG_MOVETO);
					out.writeFloat(coords[0]);
					out.writeFloat(coords[1]);
					break;
				case PathIterator.SEG_LINETO:
					out.writeCmd(DrawCommands.SEG_LINETO);
					out.writeFloat(coords[0]);
					out.writeFloat(coords[1]);
					break;
				case PathIterator.SEG_QUADTO:
					out.writeCmd(DrawCommands.SEG_QUADTO);
					out.writeFloat(coords[0]);
					out.writeFloat(coords[1]);
				...
				case PathIterator.SEG_CUBICTO:
					out.writeCmd(DrawCommands.SEG_CUBICTO);
					out.writeFloat(coords[0]);
					out.writeFloat(coords[1]);
					out.writeFloat(coords[2]);
					out.writeFloat(coords[3]);
				...
				case PathIterator.SEG_CLOSE:
					out.writeCmd(DrawCommands.SEG_CLOSE);
					break;
			}
			pi.next();
		}
		out.writeCmd(DrawCommands.PATHEND);
	}
	...
	public void drawLine(int x1, int y1, int x2, int y2)
	{
		...
		out.writeCmd(DrawCommands.DRAWLINE);
		wInt(x1, y1, x2, y2);
	...
	public void drawRect(int x, int y, int width, int height)
	{
		...
		out.writeCmd(DrawCommands.DRAWRECT);
	...
	public void fillRect(int x, int y, int width, int height)
	{
		...
		out.writeCmd(DrawCommands.FILLRECT);
		wInt(x, y, width, height);
	}
	...
	public void drawRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight)
	{
		...
		out.writeCmd(DrawCommands.DRAWROUNDRECT);
		wInt(x, y, width, height);
	...
	public void fillRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight)
	{
		...
		out.writeCmd(DrawCommands.FILLROUNDRECT);
		wInt(x, y, width, height);
		wInt(arcWidth, arcHeight);
	}
	...
	public void drawOval(int x, int y, int width, int height)
	{
		...
		out.writeCmd(DrawCommands.DRAWOVAL);
		wInt(x, y, width, height);
	}
	...
	public void fillOval(int x, int y, int width, int height)
	{
		...
		out.writeCmd(DrawCommands.FILLOVAL);
		wInt(x, y, width, height);
	}
	...
	public void drawArc(int x, int y, int width, int height, int startAngle, int arcAngle)
	{
		...
		out.writeCmd(DrawCommands.DRAWARC);
		wInt(x, y, width, height);
	...
	public void fillArc(int x, int y, int width, int height, int startAngle, int arcAngle)
	{
		...
		out.writeCmd(DrawCommands.FILLARC);
		wInt(x, y, width, height);
		wInt(startAngle, arcAngle);
	}
	...
	public void drawPolyline(int[] xPoints, int[] yPoints, int nPoints)
	{
		if (nPoints > 0)
		{
			out.writeCmd(DrawCommands.DRAWPOLYLINE);
	...
	public void drawPolygon(int[] xPoints, int[] yPoints, int nPoints)
	{
		...
		out.writeCmd(DrawCommands.DRAWPOLYGON);
		out.writeInt(nPoints);
		for (int i = 0; i < nPoints; i++)
		{
			wInt(xPoints[i], yPoints[i]);
	...
	public void fillPolygon(int[] xPoints, int[] yPoints, int nPoints)
	{
		...
		out.writeCmd(DrawCommands.FILLPOLYGON);
		out.writeInt(nPoints);
		for (int i = 0; i < nPoints; i++)
		{
			wInt(xPoints[i], yPoints[i]);
	...
	public void drawString(String str, int x, int y)
	{
		...
		out.writeCmd(DrawCommands.DRAWSTRING);
		wInt(x, y);
		wStr(str);
	}
	...
	public void drawString(String str, float x, float y)
	{
		if (str == null || str.length() == 0)
			return;
		debugPrintln("drawString(" + x + "," + y + ",\"" + str + "\")");
		out.writeCmd(DrawCommands.DRAWSTRINGF);
		out.writeFloat(x);
		out.writeFloat(y);
		wStr(str);
	...
	public void draw(Shape s)
	{
		...
		out.writeCmd(DrawCommands.DRAWSHAPE);
	...
	public void fill(Shape s)
	{
		...
		out.writeCmd(DrawCommands.FILLSHAPE);
		wPath(s.getPathIterator(null));
		//mWriter.fill(s);
	}
	...
	public void close()
	{
		out.writeCmd(DrawCommands.CLOSE);
		debugPrintln("close");
		//mWriter.close();
		out.close();
	...
	{
		out.writeCmd(DrawCommands.CREATE);
	...
	public void dispose()
	{
		...
		out.writeCmd(DrawCommands.DISPOSE);
		state.dispose();
	...
	public void setBackground(Color color)
	{
		...
		out.writeCmd(DrawCommands.SETBACKGROUND);
	...
	{
		state.setColor(c);
		out.writeCmd(DrawCommands.SETCOLOR);
	...
	public void setFont(Font font)
	{
		...
		out.writeCmd(DrawCommands.SETFONT);
		wFont(font);
	}
	...
	public void setStroke(Stroke s)
	{
		...
		out.writeCmd(DrawCommands.SETSTROKE);
	...
	public void clip(Shape s)
	{
		intersectClip(s);
		if (s == null)
			out.writeCmd(DrawCommands.CLEARCLIP);
		else
		{
			out.writeCmd(DrawCommands.CLIPSHAPE);
			wPath(s.getPathIterator(null));
		}
	}
	...
	public void clipRect(int x, int y, int width, int height)
	{
		...
		out.writeCmd(DrawCommands.CLIPRECT);
		wInt(x, y, width, height);
	}
	...
	public void setClip(Shape clip)
	{
		...
		if (clip == null)
			out.writeCmd(DrawCommands.CLEARSETCLIP);
		else
		{
			out.writeCmd(DrawCommands.SETCLIPSHAPE);
	...
	public void setClip(int x, int y, int width, int height)
	{
		...
		out.writeCmd(DrawCommands.SETCLIPRECT);
		wInt(x, y, width, height);
	...
	public void drawGlyphVector(GlyphVector g, float x, float y)
	{
		...
		debugPrintln("}");
		out.writeCmd(DrawCommands.GLYPHVECTOR);
		out.writeFloat(x);
		out.writeFloat(y);
		wFont(g.getFont());
	...
	{
		out.writeCmd(DrawCommands.CLEARRECT);
		wInt(x, y, width, height);
	...
	{
		out.writeCmd(DrawCommands.IMAGETR);
		wTransform(xform);
		wObject(img);
	...
	public boolean drawImage(Image img, int x, int y, ImageObserver observer)
	{
		...
		out.writeCmd(DrawCommands.IMAGEXY);
		wInt(x, y);
		wObject(img);
		return true;
	}
	...
	public boolean drawImage(Image img, int x, int y, int width, int height, ImageObserver observer)
	{
		...
		out.writeCmd(DrawCommands.IMAGEXYWH);
		wInt(x,y,width,height);
		wObject(img);
		return true;
	}
	...
	{
		state.rotate(theta);
		out.writeCmd(DrawCommands.ROTATE);
	...
	public void rotate(double theta, double x, double y)
	{
		...
		if (theta == 0)
			return;
		out.writeCmd(DrawCommands.ROTATEXY);
		out.writeDouble(theta);
		out.writeDouble(x);
		out.writeDouble(y);
	...
	{
		state.scale(sx, sy);
		out.writeCmd(DrawCommands.SCALEXY);
		out.writeDouble(sx);
		out.writeDouble(sy);
		debugPrintln("scale");
	}
	...
	public void setPaint(Paint paint)
	{
		...
		out.writeCmd(DrawCommands.SETPAINT);
		wObject(paint);
	...
	public void setTransform(AffineTransform tx)
	{
		...
		out.writeCmd(DrawCommands.SETTRANSFORM);
		wTransform(tx);
	...
	{
		state.shear(shx, shy);
		out.writeCmd(DrawCommands.SHEAR);
		out.writeDouble(shx);
		out.writeDouble(shy);
	...
	{
		state.transform(tx);
		out.writeCmd(DrawCommands.CONCATTRANSFORM);
		wTransform(tx);
	...
	public void translate(double tx, double ty)
	{
		...
		out.writeCmd(DrawCommands.TRANSLATEF);
		out.writeDouble(tx);
		out.writeDouble(ty);
	...
	{
		state.translate(x, y);
		out.writeCmd(DrawCommands.TRANSLATE);
		wInt(x, y);
	...
	public void setRenderingHint(RenderingHints.Key hintKey, Object hintValue)
	{
		...
		if (m.currVal == hintValue) // value already set skip it
			return;
		m.currVal = hintValue;
		out.writeCmd(DrawCommands.SETRENDERINGHINT);
	...
	public void setRenderingHints(Map<?,?> hints)
	{
		...
		wRenderingHints("setRenderingHints", DrawCommands.SETRENDERINGHINTS, hints);
	}
	...
	public void addRenderingHints(Map<?,?> hints)
	{
		// rendering hints are currently ignored. Tough luck.
		state.getRenderingHints().putAll(hints);
		wRenderingHints("addRenderingHints", DrawCommands.ADDRENDERINGHINTS, hints);
	}
	...
	public void setComposite(Composite comp)
	{
		if (comp instanceof AlphaComposite)
		{
			...
			out.writeCmd(DrawCommands.ALPHACOMPOSITE);
	...
	{
		out.writeCmd(DrawCommands.SETPAINTMODE);
		debugPrintln("setPaintMode");
	}

	public void setXORMode(Color color)
	{
		out.writeCmd(DrawCommands.SETXORMODE);
